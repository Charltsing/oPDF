# oPDF
  oPDF v2.0 may be the first software to fully showcase the [Wice](https://github.com/aelyo-softworks/Wice) UI framework. The reason why it is said to be the first one is that I submitted nearly 70 issues to make my software UI run and implement the necessary features (large text output, high DPI, and AOT publishing). So I want to thank [smourier](https://github.com/smourier) for making the birth of oPDF software possible.
