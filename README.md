...
**Tips:**  1. Turn on transparency effects in Windows 11, Open Settings → Personalization → Colors, then toggle on Transparency effects.
2. Hover the mouse over the label to see help information.  
    
**I want to declare two prerequisite skills:**  1. The prerequisite for using oPDF is to understand the PDF operators instructions, all of which are included in the *Introduction*.
