...
2. Before analyzing the watermark, first take a look at the *View resource images* to determine if the watermark is drawn on the image. If so, you will need my other software - Picture Magick Pro.
